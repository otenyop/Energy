CREATE TABLE CM_CURRENCIES 
   ...
   CREATE TABLE CM_PERIOD_STATUS_TYPES   
   (
	...
	ALTER TABLE CM_PERIOD_STATUS_TYPES
	ADD CONSTRAINT CM_PRD_STATUS_TYPES_NAME_UK UNIQUE 
	(
	  NAME 
	)
	ENABLE;   
   ...
   (
	...
	LAST_UPDATED_BY 			NUMBER(15) 				DEFAULT 1			NOT NULL, 	
	LAST_UPDATE_LOGIN 			NUMBER(15) 			    DEFAULT 1			NOT NULL,
	CONSTRAINT CM_USER_ID_PK PRIMARY KEY 
	  (
		CM_USER_ID
	  )
	  ENABLE
	...
	ADD CONSTRAINT CM_USER_USER_NAME_UK UNIQUE 
	(
	  USER_NAME
	)
	ENABLE;  	
  ...
  CREATE TABLE CM_BUSINESS_GROUPS
   ...
   CREATE TABLE CM_OPERATING_UNITS
   (	
	...
	ALTER TABLE CM_OPERATING_UNITS
	ADD CONSTRAINT OU_BUSINESS_GROUP_ID_FK FOREIGN KEY
	(
	  BUSINESS_GROUP_ID
	)
	REFERENCES CM_BUSINESS_GROUPS
	(
	  BUSINESS_GROUP_ID
	)
	ENABLE;   
	
   CREATE TABLE FIN_CALENDAR_HEADERS
   (	
	FIN_CALENDAR_ID           	NUMBER(15) 					NOT NULL,
	FIN_CALENDAR_NAME           VARCHAR2(15) 				NOT NULL,
	...
	LAST_UPDATED_BY 			NUMBER(15,0) 			DEFAULT 1			NOT NULL, 	
	LAST_UPDATE_LOGIN 			NUMBER(15,0) 			DEFAULT 1			NOT NULL,
	CONSTRAINT FIN_CALENDAR_ID_PK PRIMARY KEY 
	  (
		FIN_CALENDAR_ID
	  )
	  ENABLE		
   ...
   CREATE TABLE FIN_CALENDAR_LINES
   (	
	FIN_CALENDAR_LINE_ID         NUMBER(15) 					NOT NULL,
	FIN_CALENDAR_ID           	NUMBER(15) 					NOT NULL,	
	...
	LAST_UPDATED_BY 			NUMBER(15,0) 			DEFAULT 1			NOT NULL, 	
	LAST_UPDATE_LOGIN 			NUMBER(15,0) 			DEFAULT 1			NOT NULL,
	CONSTRAINT FIN_CALENDAR_LINE_ID_PK PRIMARY KEY 
	  (
		FIN_CALENDAR_LINE_ID
	  )
	  ENABLE		
   );   

   	ALTER TABLE FIN_CALENDAR_LINES
	ADD CONSTRAINT CALNDR_LINES_FN_CALENDAR_ID_FK FOREIGN KEY
	(
	  FIN_CALENDAR_ID
	)
	REFERENCES FIN_CALENDAR_HEADERS
	(
	  FIN_CALENDAR_ID
	)
	ENABLE; 
   ...
   (	
	FIN_PERIOD_ID         		NUMBER(15) 					NOT NULL,
	OPERATING_UNIT_ID           NUMBER(15) 					NOT NULL,	
	FIN_CALENDAR_LINE_ID         NUMBER(15) 				NOT NULL,	
	PERIOD_STATUS_TYPE_ID		NUMBER(15)					NOT NULL,
	CREATION_DATE 				DATE					DEFAULT SYSDATE		NOT NULL, 
	...
	ADD CONSTRAINT FNPRD_OPERATING_UNIT_ID_FK FOREIGN KEY
	(
	  OPERATING_UNIT_ID
	)
	REFERENCES CM_OPERATING_UNITS
	(
	  OPERATING_UNIT_ID
	)
	ENABLE;  
   	...
   	ALTER TABLE FIN_PERIODS
	ADD CONSTRAINT FNPRD_FN_CALENDAR_LINE_ID_FK FOREIGN KEY
	(
	  FIN_CALENDAR_LINE_ID
	)
	REFERENCES FIN_CALENDAR_LINES
	(
	  FIN_CALENDAR_LINE_ID
	)
	ENABLE;  
   	...
   	ALTER TABLE FIN_PERIODS
	ADD CONSTRAINT FNPRD_PERIOD_STATUS_TYPE_ID_FK FOREIGN KEY
	(
	  PERIOD_STATUS_TYPE_ID
	)
	REFERENCES CM_PERIOD_STATUS_TYPES
	(
	  PERIOD_STATUS_TYPE_ID
	)
	ENABLE;  	
   ...
   (	
	...
	ENABLE;  
   	...
   	ALTER TABLE INV_INVENTORY_ORGANIZATIONS
	ADD CONSTRAINT INVORG_FN_CALENDAR_ID_FK FOREIGN KEY
	(
	  FIN_CALENDAR_ID
	)
	REFERENCES FIN_CALENDAR_HEADERS
